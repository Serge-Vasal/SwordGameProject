...
public class CharacterStats_SO : ScriptableObject
{
    ...
    {        
        ...
        weaponPickUp.transform.parent= weaponSlot.transform;
        weaponPickUp.transform.position = weaponSlot.transform.position;
        weaponPickUp.transform.rotation = weaponSlot.transform.rotation;
